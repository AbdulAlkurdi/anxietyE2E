...
for clas in  fcnM cnnM resnetM mcdcnnM  inceptionM stresnetM; do  #encoderM  mlpM mlpLstmM cnnLstmM; do 
  for dataset in wesad; do
    for max_eval in $(seq 1 2); do # $(seq 1 10); do
      for i_fold in 00; do # 01 02 03 04; do
